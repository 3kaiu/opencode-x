...
import { Event as EventNs } from "@opencode-ai/core/event"
...
describe("v2 location HttpApi", () => {
  test("decodes Event location refs without resolved project metadata", () => {
    expect(
  ...
  test("streams native Event payloads across locations", async () => {
