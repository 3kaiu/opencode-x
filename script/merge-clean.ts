...
const removedOpencodePaths = [
  ...
  "packages/opencode/test/account",
  "packages/opencode/test/fake/account.ts",
  ...
  // Dead-code audit batch: orphan files / zero-reference modules deleted by the fork.
  ...
  "packages/opencode/src/dream/trigger.ts",
  "packages/opencode/src/dream",
  ...
  "packages/core/src/subagent/spawner.ts",
  "packages/core/src/subagent/worker.ts",
  "packages/core/src/subagent/depth.ts",
  "packages/core/src/subagent/registry.ts",
  "packages/core/src/tool/spawn-agent.ts",
  "packages/server/src/routes.ts",
  "packages/tui/src/util/icon-pixel-data.ts",
  "packages/tui/src/util/format.ts",
  "packages/tui/test/util/format.test.ts",
  // SST-generated type shims referencing a root sst-env.d.ts the fork does not keep (dead `sst` leftover).
  ...
  "packages/protocol/sst-env.d.ts",
  "packages/schema/sst-env.d.ts",
  "packages/sdk/js/sst-env.d.ts",
  "packages/server/sst-env.d.ts",
  "packages/tui/sst-env.d.ts",
  // Fork pruned 40 of 45 TUI audio assets; the 5 referenced ones are kept. Upstream re-adds
  // the full set in packages/ui (a removed package), but keep the pruned paths here in case
  // upstream ever relocates audio into packages/tui.
  "packages/tui/src/assets/audio/alert-01.mp3",
  "packages/tui/src/assets/audio/alert-02.mp3",
  "packages/tui/src/assets/audio/alert-03.mp3",
  "packages/tui/src/assets/audio/alert-04.mp3",
  "packages/tui/src/assets/audio/alert-05.mp3",
  "packages/tui/src/assets/audio/alert-06.mp3",
  "packages/tui/src/assets/audio/alert-07.mp3",
  "packages/tui/src/assets/audio/alert-08.mp3",
  "packages/tui/src/assets/audio/alert-09.mp3",
  "packages/tui/src/assets/audio/alert-10.mp3",
  "packages/tui/src/assets/audio/bip-bop-02.mp3",
  "packages/tui/src/assets/audio/bip-bop-04.mp3",
  "packages/tui/src/assets/audio/bip-bop-05.mp3",
  "packages/tui/src/assets/audio/bip-bop-06.mp3",
  "packages/tui/src/assets/audio/bip-bop-07.mp3",
  "packages/tui/src/assets/audio/bip-bop-08.mp3",
  "packages/tui/src/assets/audio/bip-bop-09.mp3",
  "packages/tui/src/assets/audio/bip-bop-10.mp3",
  "packages/tui/src/assets/audio/nope-01.mp3",
  "packages/tui/src/assets/audio/nope-02.mp3",
  "packages/tui/src/assets/audio/nope-04.mp3",
  "packages/tui/src/assets/audio/nope-05.mp3",
  "packages/tui/src/assets/audio/nope-06.mp3",
  "packages/tui/src/assets/audio/nope-07.mp3",
  "packages/tui/src/assets/audio/nope-08.mp3",
  "packages/tui/src/assets/audio/nope-09.mp3",
  "packages/tui/src/assets/audio/nope-10.mp3",
  "packages/tui/src/assets/audio/nope-11.mp3",
  "packages/tui/src/assets/audio/nope-12.mp3",
  "packages/tui/src/assets/audio/staplebops-01.mp3",
  "packages/tui/src/assets/audio/staplebops-02.mp3",
  "packages/tui/src/assets/audio/staplebops-03.mp3",
  "packages/tui/src/assets/audio/staplebops-04.mp3",
  "packages/tui/src/assets/audio/staplebops-05.mp3",
  "packages/tui/src/assets/audio/staplebops-07.mp3",
  "packages/tui/src/assets/audio/yup-02.mp3",
  "packages/tui/src/assets/audio/yup-03.mp3",
  "packages/tui/src/assets/audio/yup-04.mp3",
  "packages/tui/src/assets/audio/yup-05.mp3",
  "packages/tui/src/assets/audio/yup-06.mp3",
]
...
const residualScans = [
  ...
  { pattern: 'from "@/plugin/(github-copilot|cloudflare)"', paths: ["packages/opencode/src", "packages/opencode/test"] },
  { pattern: 'from "@/account|src/account/|fake/account|AccountTest', paths: ["packages/opencode/src", "packages/opencode/test"] },
]
