...
const paid = (providers: Record<string, { models: Record<string, { cost: { input: number } }> }>) => {
  const item = providers[ProviderNs.ID.make("opencode")]
...
it.instance("provider loaded from env variable", () =>
  Effect.gen(function* () {
    ...
    expect(providers[ProviderNs.ID.anthropic]).toBeDefined()
    // Provider should retain its connection source even if custom loaders
    // merge additional options.
    expect(providers[ProviderNs.ID.anthropic].source).toBe("env")
    expect(providers[ProviderNs.ID.anthropic].options.headers["anthropic-beta"]).toBeDefined()
  }),
)
...
it.instance(
  ...
  Effect.gen(function* () {
    yield* setProcessEnv("ANTHROPIC_API_KEY", "test-api-key")
    const providers = yield* list
    expect(providers[ProviderNs.ID.anthropic]).toBeUndefined()
  }),
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const providers = yield* list
    expect(providers[ProviderNs.ID.anthropic]).toBeDefined()
    expect(providers[ProviderNs.ID.openai]).toBeUndefined()
  }),
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const providers = yield* list
    expect(providers[ProviderNs.ID.anthropic]).toBeDefined()
    const models = Object.keys(providers[ProviderNs.ID.anthropic].models)
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const providers = yield* list
    expect(providers[ProviderNs.ID.anthropic]).toBeDefined()
    expect(providers[ProviderNs.ID.anthropic].models["my-alias"]).toBeDefined()
    expect(providers[ProviderNs.ID.anthropic].models["my-alias"].name).toBe("My Custom Alias")
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("custom-provider")]).toBeDefined()
    expect(providers[ProviderNs.ID.make("custom-provider")].name).toBe("Custom Provider")
    expect(providers[ProviderNs.ID.make("custom-provider")].models["custom-model"]).toBeDefined()
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("custom-provider")].models["active-model"]).toBeDefined()
    expect(providers[ProviderNs.ID.make("custom-provider")].models["alpha-model"]).toBeUndefined()
  }),
...
experimentalModels.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("custom-provider")].models["active-model"]).toBeDefined()
    expect(providers[ProviderNs.ID.make("custom-provider")].models["alpha-model"]).toBeDefined()
  }),
  { config: alphaProviderConfig },
)
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    const provider = providers[ProviderNs.ID.make("custom-provider")]
    ...
    expect(
      providers[ProviderNs.ID.make("custom-anthropic-provider")].models["deepseek-r1"].capabilities.interleaved,
    ).toBe(false)
  }),
  {
    config: {
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    expect(providers[ProviderNs.ID.anthropic].options.timeout).toBe(60000)
    expect(providers[ProviderNs.ID.anthropic].options.headerTimeout).toBe(10000)
    expect(providers[ProviderNs.ID.anthropic].options.chunkTimeout).toBe(15000)
  }),
...
it.instance("getModel returns model for valid provider/model", () =>
  Effect.gen(function* () {
    ...
    const model = yield* provider.getModel(ProviderNs.ID.anthropic, Model.ID.make("claude-sonnet-4-6"))
...
it.instance("getModel throws ModelNotFoundError for invalid model", () =>
  Effect.gen(function* () {
    ...
    const exit = yield* Provider.use
      .getModel(ProviderNs.ID.anthropic, Model.ID.make("nonexistent-model"))
      .pipe(Effect.exit)
...
it.instance("getModel throws ModelNotFoundError for invalid provider", () =>
  Effect.gen(function* () {
    const exit = yield* Provider.use
      .getModel(ProviderNs.ID.make("nonexistent-provider"), Model.ID.make("some-model"))
      .pipe(Effect.exit)
    expect(exit._tag).toBe("Failure")
  }),
)
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("custom-openai")]).toBeDefined()
    expect(providers[ProviderNs.ID.make("custom-openai")].options.baseURL).toBe("https://custom.openai.com/v1")
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    const model = providers[ProviderNs.ID.make("test-provider")].models["test-model"]
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    const model = providers[ProviderNs.ID.anthropic].models["claude-sonnet-4-6"]
...
it.instance("closest finds model by partial match", () =>
  Effect.gen(function* () {
    yield* set("ANTHROPIC_API_KEY", "test-api-key")
    const result = yield* Provider.use.closest(ProviderNs.ID.anthropic, ["sonnet-4"])
...
it.instance("closest returns undefined for nonexistent provider", () =>
  Effect.gen(function* () {
    const result = yield* Provider.use.closest(ProviderNs.ID.make("nonexistent"), ["model"])
...
it.instance(
  ...
  Effect.gen(function* () {
    yield* set("ANTHROPIC_API_KEY", "test-api-key")
    const providers = yield* list
    expect(providers[ProviderNs.ID.anthropic].models["my-sonnet"]).toBeDefined()

    const model = yield* Provider.use.getModel(ProviderNs.ID.anthropic, Model.ID.make("my-sonnet"))
    expect(model).toBeDefined()
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    expect(providers[ProviderNs.ID.make("custom-api")].models["model-1"].api.url).toBe("https://api.example.com/v1")
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("custom-api")].options.baseURL).toBe("https://custom.override.com/v1")
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const providers = yield* list
    const model = providers[ProviderNs.ID.openai].models["custom-gpt-chat"]
...
it.instance("getSmallModel returns appropriate small model", () =>
  Effect.gen(function* () {
    yield* set("ANTHROPIC_API_KEY", "test-api-key")
    const model = yield* Provider.use.getSmallModel(ProviderNs.ID.anthropic)
    expect(model).toBeDefined()
...
it.instance("getSmallModel prefers Gemini for Google Vertex", () =>
  Effect.gen(function* () {
    ...
    const model = yield* Provider.use.getSmallModel(ProviderNs.ID.googleVertex)
    expect(model).toBeDefined()
...
it.instance(
  ...
  Effect.gen(function* () {
    const model = yield* Provider.use.getSmallModel(ProviderNs.ID.make("test-provider"))
    expect(model?.id).toBe(Model.ID.make("new-flash"))
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    const model = yield* Provider.use.getSmallModel(ProviderNs.ID.make("test-provider"))
    expect(model?.id).toBe(Model.ID.make("claude-haiku"))
  }),
  {
    config: {
      provider: {
...
it.instance("getSmallModel skips inferred models for Azure", () =>
  Effect.gen(function* () {
    ...
    const model = yield* Provider.use.getSmallModel(ProviderNs.ID.azure)
    expect(model).toBeUndefined()
  }),
)
...
it.instance("getSmallModel skips inferred models for Azure Cognitive Services", () =>
  Effect.gen(function* () {
    ...
    const model = yield* Provider.use.getSmallModel(ProviderNs.ID.make("azure-cognitive-services"))
    expect(model).toBeUndefined()
  }),
)
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const providers = yield* list
    expect(providers[ProviderNs.ID.anthropic]).toBeDefined()
    expect(providers[ProviderNs.ID.openai]).toBeDefined()
    expect(providers[ProviderNs.ID.anthropic].options.timeout).toBe(30000)
    expect(providers[ProviderNs.ID.openai].options.timeout).toBe(60000)
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("local-llm")]).toBeDefined()
    expect(providers[ProviderNs.ID.make("local-llm")].models["llama-3"].api.npm).toBe("@ai-sdk/openai-compatible")
    expect(providers[ProviderNs.ID.make("local-llm")].options.baseURL).toBe("http://localhost:11434/v1")
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    yield* set("ANTHROPIC_API_KEY", "test-api-key")
    const providers = yield* list
    expect(providers[ProviderNs.ID.anthropic].models["sonnet"].name).toBe("sonnet")
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("multi-env")]).toBeDefined()
    // When multiple env options exist, key should NOT be auto-set
    expect(providers[ProviderNs.ID.make("multi-env")].key).toBeUndefined()
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("single-env")]).toBeDefined()
    // Single env option should auto-set key
    expect(providers[ProviderNs.ID.make("single-env")].key).toBe("my-api-key")
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    yield* set("ANTHROPIC_API_KEY", "test-api-key")
    const providers = yield* list
    const model = providers[ProviderNs.ID.anthropic].models["claude-sonnet-4-20250514"]
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("brand-new-provider")]).toBeDefined()
    expect(providers[ProviderNs.ID.make("brand-new-provider")].name).toBe("Brand New")
    const model = providers[ProviderNs.ID.make("brand-new-provider")].models["new-model"]
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    expect(providers[ProviderNs.ID.google]).toBeUndefined()
  }),
  {
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("no-tools")].models["basic-model"].capabilities.toolcall).toBe(false)
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("default-tools")].models["model"].capabilities.toolcall).toBe(true)
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    const model = providers[ProviderNs.ID.make("headers-provider")].models["model"]
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    expect(providers[ProviderNs.ID.make("fallback-env")]).toBeDefined()
  }),
  {
    config: {
      provider: {
...
it.instance("getModel returns consistent results", () =>
  Effect.gen(function* () {
    yield* set("ANTHROPIC_API_KEY", "test-api-key")
    const model1 = yield* Provider.use.getModel(ProviderNs.ID.anthropic, Model.ID.make("claude-sonnet-4-6"))
    const model2 = yield* Provider.use.getModel(ProviderNs.ID.anthropic, Model.ID.make("claude-sonnet-4-6"))
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("my-custom-id")].name).toBe("my-custom-id")
  }),
  {
    config: {
      provider: {
...
it.instance("ModelNotFoundError includes suggestions for typos", () =>
  Effect.gen(function* () {
    ...
    const error = yield* Provider.use
      .getModel(ProviderNs.ID.anthropic, Model.ID.make("claude-sonet-4"))
      .pipe(Effect.flip)
...
it.instance("ModelNotFoundError for provider includes suggestions", () =>
  Effect.gen(function* () {
    yield* set("ANTHROPIC_API_KEY", "test-api-key")
    const error = yield* Provider.use
      .getModel(ProviderNs.ID.make("antropic"), Model.ID.make("claude-sonnet-4"))
      .pipe(Effect.flip)
    expect(error.suggestions).toBeDefined()
...
it.instance("ModelNotFoundError suggests catalog models for unloaded providers", () =>
  Effect.gen(function* () {
    ...
    const error = yield* Provider.use
      .getModel(ProviderNs.ID.opencode, Model.ID.make("claude-haiku-fake-model"))
      .pipe(Effect.flip)
...
it.instance("getProvider returns undefined for nonexistent provider", () =>
  Effect.gen(function* () {
    const provider = yield* Provider.Service.use((svc) => svc.getProvider(ProviderNs.ID.make("nonexistent")))
...
it.instance("getProvider returns provider info", () =>
  Effect.gen(function* () {
    yield* set("ANTHROPIC_API_KEY", "test-api-key")
    const provider = yield* Provider.use.getProvider(ProviderNs.ID.anthropic)
...
it.instance("closest returns undefined when no partial match found", () =>
  Effect.gen(function* () {
    yield* set("ANTHROPIC_API_KEY", "test-api-key")
    const result = yield* Provider.use.closest(ProviderNs.ID.anthropic, ["nonexistent-xyz-model"])
    expect(result).toBeUndefined()
  }),
)
...
it.instance("closest checks multiple query terms in order", () =>
  Effect.gen(function* () {
    ...
    const result = yield* Provider.use.closest(ProviderNs.ID.anthropic, ["nonexistent", "haiku"])
    expect(result).toBeDefined()
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    const model = providers[ProviderNs.ID.make("no-limit")].models["model"]
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    expect(providers[ProviderNs.ID.anthropic].options.timeout).toBe(30000)
    expect(providers[ProviderNs.ID.anthropic].options.headers["X-Custom"]).toBe("custom-value")
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("nvidia")].options.headers).toEqual({
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("nvidia")].options.headers["X-BILLING-INVOKE-ORIGIN"]).toBe("CustomOrigin")
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    yield* set("OPENAI_API_KEY", "test-api-key")
    const providers = yield* list
    const model = providers[ProviderNs.ID.openai].models["my-custom-model"]
    expect(model).toBeDefined()
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const providers = yield* list
    expect(providers[ProviderNs.ID.openrouter]).toBeDefined()

    // New model not in database should inherit api.url from provider
    const intellect = providers[ProviderNs.ID.openrouter].models["prime-intellect/intellect-3"]
    ...
    const deepseek = providers[ProviderNs.ID.openrouter].models["deepseek/deepseek-r1-0528"]
...
it.instance(
  ...
  Effect.gen(function* () {
    yield* set("OPENAI_API_KEY", "test-api-key")
    const providers = yield* list
    const model = providers[ProviderNs.ID.openai].models["gpt-5"]
    expect(model.variants).toBeDefined()
    expect(model.variants!["high"]).toBeUndefined()
...
it.instance(
  ...
  Effect.gen(function* () {
    const providers = yield* list
    const model = providers[ProviderNs.ID.make("custom-reasoning")].models["reasoning-model"]
    expect(model.variants).toBeDefined()
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("vertex-proxy")]).toBeDefined()
    expect(providers[ProviderNs.ID.make("vertex-proxy")].options.baseURL).toBe("https://my-proxy.com/v1")
  }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  Effect.gen(function* () {
    yield* set("GOOGLE_APPLICATION_CREDENTIALS", "test-creds")
    const providers = yield* list
    const model = providers[ProviderNs.ID.make("vertex-openai")].models["gpt-4"]
    expect(model).toBeDefined()
...
it.instance("Google Vertex: uses REP endpoint for Claude continental multi-regions", () =>
  Effect.gen(function* () {
    ...
    const model = yield* provider.getModel(
      ProviderNs.ID.make("google-vertex"),
      Model.ID.make("claude-sonnet-4-6@default"),
    )
    const language = yield* provider.getLanguage(model)
...
it.instance("Google Vertex Anthropic: uses REP endpoint for continental multi-regions", () =>
  Effect.gen(function* () {
    ...
    const provider = yield* Provider.Service
    const model = yield* provider.getModel(
      ProviderNs.ID.make("google-vertex-anthropic"),
      Model.ID.make("claude-sonnet-4-6@default"),
    )
    const language = yield* provider.getLanguage(model)
    expect(languageBaseURL(language)).toBe(
...
it.instance("cloudflare-ai-gateway loads with env variables", () =>
  Effect.gen(function* () {
    ...
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("cloudflare-ai-gateway")]).toBeDefined()
  }),
)
...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const providers = yield* list
    expect(providers[ProviderNs.ID.make("cloudflare-ai-gateway")]).toBeDefined()
    expect(providers[ProviderNs.ID.make("cloudflare-ai-gateway")].options.metadata).toEqual({
      invoked_by: "test",
      project: "opencode",
    })
  }),
...
it.effect("plugin config providers persist after instance dispose", () =>
  Effect.gen(function* () {
    ...
    expect(first[ProviderNs.ID.make("demo")]).toBeDefined()
    expect(first[ProviderNs.ID.make("demo")].models[Model.ID.make("chat")]).toBeDefined()

    yield* Effect.promise(() => disposeAllInstances())

    const second = yield* loadAndList
    expect(second[ProviderNs.ID.make("demo")]).toBeDefined()
    expect(second[ProviderNs.ID.make("demo")].models[Model.ID.make("chat")]).toBeDefined()
