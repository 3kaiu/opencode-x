// V2 event bus (M6). Copied from core/src/bus.ts into the V2 namespace.
// Shared global singletons (Database, event tables, location, node makers) are
// imported from the legacy tree — they must remain single instances.
import { Cause, Context, Effect, Layer, Option, PubSub, Queue, Schema, Stream } from "effect"
import { Event } from "@opencode-ai/schema/event"
import type { Data, Definition, Payload } from "@opencode-ai/schema/event"
import { and, asc, eq, gt, inArray } from "drizzle-orm"
import { Database } from "../shared/database"
import { EventSequenceTable, EventTable } from "../shared/event-sql"
import { Location } from "../shared/location"
import { makeGlobalNode } from "../shared/app-node"
...
export const latestSequence = Effect.fn("V2Events.latestSequence")(function* (
 ...
 */
export const advanceSequence = Effect.fn("V2Events.advanceSequence")(function* (
  db: Database.Interface["db"],
  aggregateID: string,
  seq: number,
) {
...
export const readAggregate = Effect.fn("V2Events.readAggregate")(function* <A>(
  db: Database.Interface["db"],
  input: {
    readonly aggregateID: string
...
export class Service extends Context.Service<Service, Interface>()("@opencode/v2/Events") {}
