...
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      expect(providers[ProviderNs.ID.amazonBedrock]).toBeDefined()
      expect(providers[ProviderNs.ID.amazonBedrock].options?.region).toBe("eu-west-1")
    }),
...
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      yield* set("AWS_ACCESS_KEY_ID", "")
      yield* set("AWS_BEARER_TOKEN_BEDROCK", "")
      const model = yield* Provider.use.getModel(ProviderNs.ID.amazonBedrock, Model.ID.make("openai.gpt-5.5"))
...
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      const providers = yield* list
      expect(providers[ProviderNs.ID.amazonBedrock]).toBeDefined()
      expect(providers[ProviderNs.ID.amazonBedrock].options?.region).toBe("us-east-1")
    }),
  {
    config: {
...
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      const providers = yield* list
      expect(providers[ProviderNs.ID.amazonBedrock]).toBeDefined()
      expect(providers[ProviderNs.ID.amazonBedrock].options?.endpoint).toBe(
...
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      const providers = yield* list
      expect(providers[ProviderNs.ID.amazonBedrock]).toBeDefined()
      expect(providers[ProviderNs.ID.amazonBedrock].models["us.anthropic.claude-opus-4-5-20251101-v1:0"]).toBeDefined()
    }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      expect(providers[ProviderNs.ID.amazonBedrock]).toBeDefined()
      expect(
        providers[ProviderNs.ID.amazonBedrock].models["global.anthropic.claude-opus-4-5-20251101-v1:0"],
      ).toBeDefined()
    }),
  {
    config: {
...
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      const providers = yield* list
      expect(providers[ProviderNs.ID.amazonBedrock]).toBeDefined()
      expect(providers[ProviderNs.ID.amazonBedrock].models["eu.anthropic.claude-opus-4-5-20251101-v1:0"]).toBeDefined()
    }),
  {
    config: {
      provider: {
...
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      const providers = yield* list
      expect(providers[ProviderNs.ID.amazonBedrock]).toBeDefined()
      expect(providers[ProviderNs.ID.amazonBedrock].models["anthropic.claude-opus-4-5-20251101-v1:0"]).toBeDefined()
    }),
  {
    config: {
      provider: {
