...
// Process-global pending registry. `Permission.Service` is location-scoped and
...
export const node = makeLocationNode({
  service: Service,
  layer,
  deps: [Event.node, Location.node, Agent.node, SessionStore.node, PermissionSaved.node],
})
